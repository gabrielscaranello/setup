...
- [-] Implement default applications configuration script (MIME types / protocol handlers) — partially implemented (Kitty terminal emulator, VLC video player) in `scripts/apps/setup-default-apps.sh`
