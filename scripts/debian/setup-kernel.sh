...
source "scripts/_utils.sh" 2>/dev/null || source "$(dirname "$0")/../_utils.sh" 2>/dev/null || source "$(dirname "$0")/_utils.sh"
source "scripts/debian/_repositories.sh" 2>/dev/null || source "$(dirname "$0")/_repositories.sh" 2>/dev/null || true
