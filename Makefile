...
.PHONY: help all browsers dbeaver docker flatpak fonts gitflow go kitty lazydocker lazygit neovim nvm rust test test-coverage test-integration test-unit clean
.DEFAULT_GOAL := help
