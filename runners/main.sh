...
Available Commands:
  ...
  update                  - Update package repositories and upgrade system packages
...
run_module() {
  ...
  case "$target" in
    ...
    desktop-preferences)
      bash "$SCRIPTS_DIR/desktop/setup-desktop-preferences.sh"
      ;;
    ...
    update)
      bash "$SCRIPTS_DIR/system/setup-update.sh"
      ;;
