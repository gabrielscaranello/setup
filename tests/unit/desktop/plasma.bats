...
@test "configure_plasma_preferences configures all target groups and keys" {
  ...
  [[ "$output" =~ "config: file=plasma_workspace.notifyrc group=Event/startkde key=Action val=" ]]
  [[ "$output" =~ "config: file=plasma_workspace.notifyrc group=Event/startkde key=Sound val=" ]]
  [[ "$output" =~ "config: file=plasma_workspace.notifyrc group=Event/exitkde key=Action val=" ]]
  [[ "$output" =~ "config: file=plasma_workspace.notifyrc group=Event/exitkde key=Sound val=" ]]
  [[ "$output" =~ "config: file=plasma_workspace.notifyrc group=Event/cancellogout key=Action val=" ]]
  [[ "$output" =~ "config: file=plasma_workspace.notifyrc group=Event/cancellogout key=Sound val=" ]]
  [[ "$output" =~ "config: file=plasma_workspace.notifyrc group=Event/login key=Action val=" ]]
  [[ "$output" =~ "config: file=plasma_workspace.notifyrc group=Event/login key=Sound val=" ]]
  [[ "$output" =~ "config: file=plasma_workspace.notifyrc group=Event/logout key=Action val=" ]]
  [[ "$output" =~ "config: file=plasma_workspace.notifyrc group=Event/logout key=Sound val=" ]]
  [[ "$output" =~ "config: file=kscreenlocker.notifyrc group=Event/locked key=Action val=" ]]
  [[ "$output" =~ "config: file=kscreenlocker.notifyrc group=Event/locked key=Sound val=" ]]
  [[ "$output" =~ "config: file=kscreenlocker.notifyrc group=Event/unlocked key=Action val=" ]]
  [[ "$output" =~ "config: file=kscreenlocker.notifyrc group=Event/unlocked key=Sound val=" ]]
