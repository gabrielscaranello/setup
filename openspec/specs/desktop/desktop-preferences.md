...
7. **Shell & App Folders** (`shell.dconf`):
   ...
   - App picker folders: Games (`ProtonPlus`, `MangoJuice`, `Steam`), Develop (`DBeaver`, `Compass`), System (including `gufw`, `firewall-config`), Utilities (including `VLC`, `Yelp`/Help).
